...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    internal static ConfigEntry<bool> UseRawMouseLook = null!;
    internal static ConfigEntry<float> RawMouseSensitivity = null!;
    ...
    private void Awake()
    {
        ...
        SmoothCamera = Config.Bind("Camera", "SmoothCamera", false, "Smooth camera movement while first-person mode is active. Disabled by default for direct first-person control.");
        CameraSmoothing = Config.Bind("Camera", "CameraSmoothing", 18f, "How quickly the camera moves toward the first-person target. Set to 0 for instant movement.");
        UseRawMouseLook = Config.Bind("Camera", "UseRawMouseLook", true, "Use raw mouse deltas for first-person camera rotation instead of vanilla smoothed camera rotation.");
        RawMouseSensitivity = Config.Bind("Camera", "RawMouseSensitivity", 2f, "Multiplier for raw mouse look when UseRawMouseLook is enabled.");
