...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        ForceBodyVisible = Config.Bind("Visibility", "ForceBodyVisible", true, "Force non-head local player renderers visible while first-person mode is active. This counters vanilla close-camera body hiding.");
